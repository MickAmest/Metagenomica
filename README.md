...
También se encuentra el script `meta.R` con el que se realizaron los análisis de diversidad en R. También se encuentra este código en un archivo RMarkDown, así como el reporte HTML resultado de correr el código, el cual incluye las gráficas y resultados de los análisis. 

Adicionalmente, las gráficas de resultados se encuentran en la carpeta `out`. 
